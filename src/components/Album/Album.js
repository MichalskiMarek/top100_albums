                ...
                <div className="panel__collapse" style={{height: currentHeight}}>
                    <div className="collapse__body" ref="inner">
                        <div className={'body__info'}>
                            ...
                            <div className={'info__element'}>
                                <span
                                    className={'element__data'}>{this.props.album['im:releaseDate'].attributes.label}</span>
                        ...
                        <div className={`body__links ${this.state.isExpanded ? 'is-expanded' : ''}`}>
                            <div className={'links__link'}>
                                <a className={'links__link--a'} href={this.props.album.link.attributes.href} target={'_blank'}>Check out on
                                    iTunes</a>
                            </div>
                            <div className={'links__link'}>
                                <a className={'links__link--a'} href={this.props.album.category.attributes.scheme} target={'_blank'}>More artists in
                                    this
                                    category</a>
                            </div>
                        </div>
