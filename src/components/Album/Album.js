            ...
            <li className={`panel ${this.state.isExpanded ? 'is-expanded' : ''}`}>
                ...
                <div className="panel-collapse" style={{height: currentHeight}}>
                    <div className="panel-body" ref="inner">
                        ...
                        <div>
                            <a href={this.props.album.link.attributes.href} target={'_blank'}>Check out on iTunes</a>
                        </div>
                        <div>
                            <a href={this.props.album.category.attributes.scheme} target={'_blank'}>More artists in this category</a>
                        </div>
                    </div>
                </div>
            </li>
